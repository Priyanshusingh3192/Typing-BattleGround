...
function App() {
    ...
    return (
        <div className="background-container">
            ...
            {/* Main Form */}
            <MDBContainer fluid style={{ minHeight: '100vh', padding: '0.25vw' }}>
                <MDBCard className="text-black bg-gray-800 m-5" style={{ borderRadius: '25px',background: "#ebebf0" }}>
                    <MDBCardBody>
                            ...
                            <MDBRow>
                                <MDBCol md="10" lg="6" className="order-2 order-lg-1 d-flex flex-column align-items-center">
                                    ...
                                    <div className="d-flex flex-row align-items-center mb-4">
                                        ...
                                        <MDBInput label="Username" id="formUsername" type="text" className="w-100" name="username" onChange={handleChange} />
                                    </div>
                                    <div className="d-flex flex-row align-items-center mb-4">
                                    ...
                                    <div className="d-flex flex-row align-items-center mb-4">
                                        ...
                                        <MDBInput label="Password" id="form3" type="pwd" name="pwd" onChange={handleChange} />
                                    </div>
                                    <div className="d-flex flex-row align-items-center mb-4">
                                        <MDBIcon fas icon="key me-3" size="lg" />
                                        <MDBInput label="Confirm pwd" id="form4" type="pwd" name="confirmPassword" onChange={handleChange} />
                                    </div>
                                    <div className="mb-4">
                                        <MDBCheckbox name="newsletter" id="flexCheckDefault" label="Subscribe to our newsletter" onChange={handleChange} />
                                    </div>
                                ...
                                <MDBCol md="10" lg="6" className="order-1 order-lg-2 d-flex align-items-center">
                                    <MDBCardImage src="https://talentmed.edu.au/wp-content/uploads/2018/08/Untitled-design-32.png" fluid />
                                </MDBCol>
                            </MDBRow>
                        </form>
                    </MDBCardBody>
